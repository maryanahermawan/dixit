...
let GameComponent = class GameComponent {
    constructor(gameService, fb, route) {
    ...
    createPlayerAsset(gameId, playerId) {
...
let GroupWaitingComponent = class GroupWaitingComponent {
    constructor(route, gameSvc, router) {
        this.route = route;
        this.gameSvc = gameSvc;
        this.router = router;
    }
...
GroupWaitingComponent.ctorParameters = () => [
...
let TransitionGroupItemDirective = class TransitionGroupItemDirective {
    constructor(elRef) {
        this.el = elRef.nativeElement;
    }
};
TransitionGroupItemDirective.ctorParameters = () => [
...
let TransitionGroupComponent = class TransitionGroupComponent {
    ngAfterContentInit() {
    ...
    runTransition(card) {
        ...
        el.addEventListener('transitionend', card.moveCallback = (e) => {
...
let GameService = class GameService {
    ...
    chooseActiveCard(gameId, playerId, cardId) {
        return this.http.get(`/game/card/active/${gameId}/${playerId}/${cardId}`)
            .toPromise();
    }
    chooseGuessCard(gameId, playerId, cardId) {
    ...
    getAllGroups() {
        ...
        return (this.http.get('/api/groups', { headers })
            .toPromise());
    }
    login(formObj) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"];
